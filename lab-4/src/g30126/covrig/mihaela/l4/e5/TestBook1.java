package g30126.covrig.mihaela.l4.e5;
...
import g30126.covrig.mihaela.l4.e6.Book2;
public class TestBook1 {
	@Test
	public  void TestToString() {
		Author a2=new Author("Pop Dan","popdan@yahoo.com",'m');
		Book1 b1=new Book1("Maze Runner",a2,125);
	...
	public void TestGetPrice() {
	  Author  x = new Author("Mihai Eminescu", "ion.creanga@junimea.ro", 'M');
	    Book1 b1 = new Book1("Literatura Romaneasca", x, 10, 50);
	...
	public void TestGetQtyInStock() {
	   Author x = new Author("Mihai Eminescu", "ion.creanga@junimea.ro", 'M');
	   Book1 b1 = new Book1("Literatura Romaneasca Esentiala", x, 10, 50);
